...
class crazy:
	...
	def generateRandMod(self, Mod="Vanilla", balanced=False, modSeed = '', extraEquipmentCheck=False, randShipCheck=True):
...
'''
		...
		'''
		xml = open("compiledFiles/data/text_blueprints.xml.append", "w")
		
		xml.writelines(xmlShipNames)
